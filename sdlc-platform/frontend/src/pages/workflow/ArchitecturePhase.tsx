...
const ArchitecturePhase: React.FC = () => {
  ...
  const currentPhase = workflowPhases.find((p: any) => p.phaseType === 'architecture' || p.phaseType === 'ARCHITECTURE');
  ...
  return (
    <Box>
      ...
      <Typography variant="body1" paragraph>
        This phase focuses on creating the technical blueprint for the application, including all system architecture, interfaces, and design patterns.
      </Typography>
