...
const TestingPhase: React.FC = () => {
  ...
  const currentPhase = workflowPhases.find((p: any) => p.phaseType === 'testing' || p.phaseType === 'TESTING');
  ...
  return (
    <Box>
      ...
      <Typography variant="body1" paragraph>
        This phase focuses on thorough testing of all application components, ensuring functionality, performance, and security requirements are met.
      </Typography>
