...
const DeploymentPhase: React.FC = () => {
  ...
  const currentPhase = workflowPhases.find((p: any) => p.phaseType === 'deployment' || p.phaseType === 'DEPLOYMENT');
  ...
  return (
    <Box>
      ...
      <Typography variant="body1" paragraph>
        This phase focuses on the final deployment to production, user training, and establishing ongoing operational support and monitoring.
      </Typography>
